...
function vega_wp_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'vega_fontawesome_version', array( 'default' => $vega_wp_defaults['vega_fontawesome_version'], 'sanitize_callback' => 'vega_wp_sanitize_fontawesome_version' ) );
    $wp_customize->add_control( 'vega_fontawesome_version', array(
                                    'label' => __( 'Font Awesome Version', 'vega' ),
                                    'section' => 'vega_wp_general_settings_section',
                                    'settings' => 'vega_fontawesome_version', 'type' => 'radio',
                                    'choices' => array('v47'=>__('Version 4.7 (Default)', 'vega'), 'v5'=>__('Version 5.x', 'vega')),
                                    'description' => __('Choose whether you want to use Font Awesome version 4.7 or 5. For more details visit https://fontawesome.com/v4.7.0/ and https://fontawesome.com/.', 'vega') ) );
    ...
    for($i=1;$i<=8;$i++) {
        if($i == 7) continue;
        $wp_customize->add_section( 'vega_wp_frontpage_4_cols_col_'.$i.'_section' , array(
            // Translators: Column number.
            'title' => sprintf( __( 'Icon Column %s', 'vega' ), $i ),
            'priority' => 49,
            'description' => '',
            'panel'=>'vega_wp_frontpage_4_cols_panel'
        ) );
...
function vega_wp_sanitize_fontawesome_version($input){
    $valid = array(
        'v47' => 'Version 4.7',
        'v5'=> 'Version 5.x'
    );
