...
<div class="section frontpage-cta frontpage-cta2 <?php echo esc_attr( $class ); ?>" <?php echo $parallax_str; // PHPCS: XSS ok. ?> id="<?php echo esc_attr($vega_wp_frontpage_cta_dark2_section_id); ?>">
