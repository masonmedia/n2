...
add_filter( 'body_class', 'vega_body_class' );
function vega_body_class( $classes ){
    if(vega_wp_get_option('vega_fontawesome_version') == 'v5'){
        $classes[] = 'fontawesome5';
    }
	return $classes;
}
...
function vega_wp_scripts() {
    $vega_fontawesome_version = vega_wp_get_option('vega_fontawesome_version');

    /** CSS **/

    #bootstrap, fontawesome, bootstrapsocial
    wp_register_style('bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.min.css' );
    if($vega_fontawesome_version == 'v5'){
        wp_register_style('font-awesome', get_template_directory_uri().'/assets/css/font-awesome.5.css' );
    } else {
...
function vega_wp_get_col_class($n){
    switch($n){
        case 1: return 'col-sm-4 col-sm-offset-4'; break;
        case 2: return 'col-sm-4 col-sm-offset-2|col-sm-4'; break;
        ...
        case 5: return 'col-lg-2 col-md-4 col-sm-6 col-lg-offset-1|col-lg-2 col-md-4 col-sm-6|col-lg-2 col-md-4 col-sm-6|col-lg-2 col-md-4 col-sm-6|col-lg-2 col-md-4 col-sm-6'; break;
        case 6: return 'col-sm-4|col-sm-4|col-sm-4|col-sm-4|col-sm-4|col-sm-4'; break;
        case 8: return 'col-md-3 col-sm-6|col-md-3 col-sm-6|col-md-3 col-sm-6|col-md-3 col-sm-6|col-md-3 col-sm-6|col-md-3 col-sm-6|col-md-3 col-sm-6|col-md-3 col-sm-6'; break;
    }
}
endif;

#vega_wp_get_latest_posts_class
if ( ! function_exists( 'vega_wp_get_latest_posts_class' ) ) :
function vega_wp_get_latest_posts_class($n){
    switch($n){
        case 1: return 'col-sm-10 col-xs-10 col-sm-offset-1 col-xs-offset-1'; break;
        case 2: return 'col-sm-6|col-sm-6'; break;
        case 3: return 'col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6'; break;
        case 4: return 'col-md-3 col-sm-6 col-xs-6|col-md-3 col-sm-6 col-xs-6|col-md-3 col-sm-6 col-xs-6|col-md-3 col-sm-6 col-xs-6'; break;
        case 5: return 'col-md-2 col-sm-4 col-xs-6 col-md-offset-1|col-md-2 col-sm-4 col-xs-6|col-md-2 col-sm-4 col-xs-6|col-md-2 col-sm-4 col-xs-6|col-md-2 col-sm-4 col-xs-6'; break;
        case 6: return 'col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6|col-md-4 col-sm-6 col-xs-6'; break;
    }
}
endif;
...
function vega_wp_example_nav_header(){
    ...
    if(get_option('show_on_front') == 'page' || $vega_wp_enable_demo == 'Y') {
        ...
        foreach($arr as $k=>$v){
            ...
            if($v == 'content') {   echo '<li class="page-scroll"><a href="#welcome">' . esc_html__('Welcome', 'vega') . '</a></li>'; }
...
function vega_wp_example_frontpage_content(){
    ...
    echo '<div class="wow fadeInUp">'. apply_filters( 'the_content', $random_page->post_content ) .'</div>'; // PHPCS: XSS ok.
}
...
function vega_fontawesome_brand_icon($class){
    if( vega_wp_get_option('vega_fontawesome_version') == 'v5' ){
        return 'b fa-'.str_replace('fa-', '', $class);
    } else {
        return ' fa-'.str_replace('fa-', '', $class);
    }
}
