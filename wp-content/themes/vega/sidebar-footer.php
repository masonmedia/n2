...
<div class="footer-widgets bg-footer">
    <div class="container">
        <div class="row">
            ...
            <!-- Footer Col 1 -->
            <div class="<?php echo esc_attr( $class ); ?> footer-widget footer-widget-col-1 wow">
            ...
            <!-- Footer Col 2 -->
            <div class="<?php echo esc_attr( $class ); ?> footer-widget footer-widget-col-2 wow">
            ...
            <!-- Footer Col 3 -->
            <div class="<?php echo esc_attr( $class ); ?> footer-widget footer-widget-col-3 wow" >
            ...
            <!-- Footer Col 4 -->
            <div class="<?php echo esc_attr( $class ); ?> footer-widget footer-widget-col-4 wow" >
